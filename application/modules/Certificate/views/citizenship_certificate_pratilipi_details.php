            ...
            <div class="tab-content" id="nav-tabContent">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <span class="text-uppercase"><?=$result->eng_first_name." ".$result->eng_middle_name." ".$result->eng_last_name?></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>२</td>
                                        ...
                                        <?php if(!empty($result->country_name)){?>
                                                ...
                                                <?php }else{?>
                                                            ...
                                                            <td>
                                                                ...
                                                                <span class="mx-1">District:<?= $result->b_eng_district?>,</span>
                                                                <span class="mx-1">Mun/R.Mun:<?= $result->b_eng_local_body?>,</span>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <strong>Permanent Address :-</strong></strong><span class="mx-4"> <?= $result->p_eng_state?></span>
                ...
                <?php if($result->status != 1) :?>
                    <div class="tab-pane fade" id="sifaris" role="tabpanel" aria-labelledby="nav-dropdown1-tab">
                        ...
                        <div class="font-14 myfontcolor text-capitalize" style="line-height: 1.4">
                            ...
                            <h5 class="text-center mt-3"> <span class="border-b"> मैले नागरिकताको प्रमाण-पत्र लिदाको विवरण यस प्रकार छ । </span></h5>
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-12" style="border: 2px solid black; margin-top: 15px; padding-top: 15px; padding-bottom: 10px ;border-radius:15px;">
                                        <table class="table-borderless table" style="margin: 1px font-size:20px">
                                            ...
                                            <tr>
                                                ...
                                                <td class="font-normal font-16">
                                                    ...
                                                    <span class="text-uppercase"><?php echo $result->country_name_eng;?>, <?php echo $result->country_address_eng;?></span>
                                                    <?php }else{?>
                                                    Place of Birth (In block ) : District: 
                                                    <span class="text-uppercase"> <?= $result->b_eng_district?> : <?= $result->b_eng_local_body?> Ward No.: <?=$result->b_eng_ward?></span>
                                                    <?php }?>
                                                </td>
                                            </tr>
                                            <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="font-normal font-16">Permanent address :
                                                ...
                                                <span class="mx-5">Rural Municipality: <?= $result->p_eng_local_body?> </span>Ward
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                बाबुको नामथर, वतन
                                                : <?=$result->father_name?> , वडा-<?=$f_ward->name.' '.$f_local_body->name.' '.$f_district->name?>
                                        ...
                                        <tr>
                                            <td>८.</td>
                                            <td>
                                                आमाको नामथर, वतन : <?php echo $result->mother_name?>, वडा-<?=$m_ward->name.' '.$m_local_body->name.' '.$m_district->name?>
                                                <span class="ml-4">नागरिकता नं :
                ...
                <div class="row" style="margin-top: 10px;line-height: 2">
                    <div class="col-2">
                        ...
                        <br>कार्यालयको नाम :- <b><?=$result->b_eng_ward?>नं. वडा कार्यालय</b></p>
