      ...
      <div class="card-body">
              ...
              <div class="col-sm-8">
                <div class="input-group">
                  <input type="text" name="nepali_date" class="form-control" required id="nepaliDate5"
                    placeholder="YYYY-MM-DD" value="<?php echo isset($result)?$result->nepali_date:''?>" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div class=" col-md-12">
          <div class="row">
              ...
              <div class="form-group row">
                ...
                <label class="col-md-4 col-form-label">
                  <select name="gender_spec" class="form-control" id="gender_spec" required>
                    <option value="श्री"
                      <?php if(isset($result)){ if($result->gender_spec == "श्री"){ echo 'selected';}}?>>श्री </option>
                    <option value="सुश्री"
                      <?php if(isset($result)){ if($result->gender_spec == "सुश्री"){ echo 'selected';}}?>>सुश्री
                    </option>
                    <option value="श्रीमती"
                      <?php if(isset($result)){ if($result->gender_spec == "श्रीमती"){ echo 'selected';}}?>>श्रीमती
                    </option>
                  </select>
                </label>
              </div>
            ...
            <div class="col-md-6">
              <div class="col-sm-12" style="margin-left:-170px">
        ...
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group row">
                <label class="col-sm-4 col-form-label"><span class="float-right">जन्ममिति<span
                      class="text-danger">&nbsp;*</span></span></label>
                <div class="col-sm-8">
                  <div class="input-group">
                    <input type="hidden" id="curr_date"
                      value="<?= isset($result) ? $result->nepali_date : DateEngToNep(date('Y-m-d'))?>">
                    <input type="text" name="janmamiti" id="janmamiti" placeholder="YYYY-MM-DD" maxlength="10"
                      class="form-control janmamiti" required id="nepaliDate4"
                      value="<?= isset($result) ? $result->janmamiti : ''?>" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <select name="gender" class="form-control" required id="id_gender">
                      ...
                      <option value="1"
                        <?php if(isset($result) && $result->gender == 1){ echo 'selected="selected"';}?>>पुरुष
                      </option>
                      <option value="2"
                        <?php if(isset($result) && $result->gender == 2){ echo 'selected="selected"';}?>>महिला
                      </option>
                    </select>
                  </div>
                </div>
              ...
              <div class="col-md-4">
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="cit_no_1" maxlength="128" class="form-control" required id="cit_no_1"
              ...
              <div class="col-md-4">
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="con_no" maxlength="128" class="form-control" required id="con_no"
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <select name="relation" class="form-control" required id="id_relation">
                      <option value="" selected>छान्नुहोस्</option>
                      <option value="son"
                        <?php if(isset($result) && $result->relation == 'son'){ echo 'selected="selected"';}?>>
                        छोरा
                      </option>
                      <option value="daughter"
                        <?php if(isset($result) && $result->relation == 'daughter'){ echo 'selected="selected"';}?>>
                        छोरी
                      </option>
                      <option value="wife"
                        <?php if(isset($result) && $result->relation == 'wife'){ echo 'selected="selected"';}?>>
                        श्रीमती
                      </option>
                    </select>
                  </div>
