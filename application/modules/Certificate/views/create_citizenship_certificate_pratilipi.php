                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-6 col-form-label">
                                          <span class="float-right">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="citizenship_reg_date" placeholder="YYYY-MM-DD" value="<?=isset($result)?$result->citizenship_reg_date:''?>" maxlength="16" class="form-control" id="nepaliDate4" />
                                            </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                          ...
                                          <span class="float-right">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="citizenship_type" class="form-control" id="id_citizenship_type">
                                                    ...
                                                    <option value="1" <?php if(isset($result) && $result->citizenship_type==1){?>selected="selected"<?php } ?>>वंशज</option>
                                                    <option value="2" <?php if(isset($result) && $result->citizenship_type==2){?>selected="selected"<?php } ?>>जन्म</option>
                                          ...
                                          <span class="float-right">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="citizenship_type_1" class="form-control" id="citizenship_type_1">
                                                   ...
                                                   <option value="नयाँ ढाँचाको आवश्येक भएको ">नयाँ ढाँचाको आवश्येक भएको</option>
                                                   <option value="संसोधन गर्नुपर्ने">संसोधन गर्नुपर्ने</option>
                                                   </select>
                                            </div>
                                    </div>
                                </div>
                                          ...
                                          <span class="float-right">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="input-group mb-sm-2">
                                                    <input type="text" name="nep_dob" placeholder="YYYY-MM-DD" value="<?=isset($result)?$result->nep_dob:''?>" maxlength="10" class="form-control nep_dob" required id="nepaliDate3" />
                                                    <div class="input-group-append">
                                                        <span class="input-group-text">B.S.</span>
                                                    </div>
                                                    <input type="text" name="eng_dob" placeholder="YYYY-MM-DD" readonly="true" value="<?=isset($result)?$result->eng_dob:''?>" class="form-control" required id="id_eng_dob" />
                                                    <div class="input-group-append">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-3 mb-sm-2">
                                            ...
                                            <select name="b_eng_state" class="form-control select2 state_selected_en" id="state_selected_en-1" required>
                                                  <option value=""></option>
                                                  <?php if(!empty($states)) :
                                        ...
                                        <div class="col-md-3 mb-sm-2">
                                            ...
                                            <select name="b_eng_district" class="form-control select2 district_selected_en" id="selected_district_en-1" required>
                                              <?php if(!empty($districts)) :
                                                    foreach($districts as $key => $district) :?>
                                                    <option value="<?php echo $district->english_name?>" <?php if($district->id == SITE_DISTRICT_ID_EN){echo 'selected';}?>><?php echo $district->english_name?></option>
                                                <?php endforeach;endif;?>
                                            </select>
                                        </div>
                                        <div class="col-md-3 mb-sm-2">
                                            ...
                                            <select name="b_eng_local_body" class="form-control select2 select_local_body" id="local_body_selected_en-1" required class="form-control">
                                                <?php if(!empty($locals)) :
                                                    foreach($locals as $key => $l) :?>
                                                        <option value="<?php echo $l->english_name?>" <?php if($l->id == SITE_GAPA_ID_EN){echo 'selected';}?>><?php echo  $l->english_name?></option>
                                                    <?php endforeach;endif;?>
                                            </select>
                                        </div>
                                        <div class="col-md-1 mb-sm-2">
                                            <!--<input type="text" name="b_eng_ward" class="form-control" placeholder="Ward" value="<?= isset($result) ? $result->b_eng_ward : ''?>" required>-->
                                            <select name="b_eng_ward" class="form-control select2" id="selected_ward-1" required >
                                                <option value=""></option>
                                              <?php if(!empty($wards)) :
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label">
                                          <span class="float-right">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="country_name" placeholder="देशको नाम" value="<?=isset($result)?$result->country_name:''?>" maxlength="164" class="form-control" id="id_country_name" />
                                            </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label">
                                          <span class="float-right">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="country_address" placeholder="पुरा ठेगाना" value="<?=isset($result)?$result->country_address:''?>" maxlength="164" class="form-control" id="id_country_address" />
                                            </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label">
                                          <span class="float-right">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="country_name_eng" placeholder="Country Name" value="<?=isset($result)?$result->country_name_eng:''?>" maxlength="164" class="form-control" id="id_country_name_eng" />
                                            </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label">
                                          <span class="float-right">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="country_address_eng" placeholder="Full Address" value="<?=isset($result)?$result->country_address_eng:''?>" maxlength="164" class="form-control" id="id_country_address_eng" />
                                            </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-3 mb-sm-2">
                                            ...
                                            <select name="p_eng_state" class="form-control select2 state_selected_en" id="state_selected_en-1" required>
                                                  <option value=""></option>
                                                  <?php if(!empty($states)) :
                                                      foreach($states as $key => $state) :?>
                                                          <option value="<?php echo $state->english_name?>" <?php if($state->id == SITE_STATE_ID_EN){ echo 'selected';}?>><?php echo $state->english_name?></option>
                                                      <?php endforeach;endif;?>
                                            </select>
                                        </div>
                                        <div class="col-md-3 mb-sm-2">
                                            ...
                                            <select name="p_eng_district" class="form-control select2 district_selected_en" id="selected_district_en-1" required>
                                              <?php if(!empty($districts)) :
                                                    foreach($districts as $key => $district) :?>
                                                    <option value="<?php echo $district->english_name?>" <?php if($district->id == SITE_DISTRICT_ID_EN){echo 'selected';}?>><?php echo $district->english_name?></option>
                                                <?php endforeach;endif;?>
                                        ...
                                        <div class="col-md-3 mb-sm-2">
                                            ...
                                            <select name="p_eng_local_body" class="form-control select2 select_local_body" id="local_body_selected_en-1" required class="form-control">
                                                <?php if(!empty($locals)) :
                                                    foreach($locals as $key => $l) :?>
                                                        <option value="<?php echo $l->english_name?>" <?php if($l->id == SITE_GAPA_ID_EN){echo 'selected';}?>><?php echo  $l->english_name?></option>
                                                    <?php endforeach;endif;?>
                                        ...
                                        <div class="col-md-1 mb-sm-2">
                                            ...
                                            <select name="p_eng_ward" class="form-control select2" id="selected_ward-1" required >
                                                <option value=""></option>
                                              <?php if(!empty($wards)) :
                                                foreach($wards as $key => $w) :?>
                                                    <option value="<?php echo $w->name?>" <?php if($w->name == $this->session->userdata('ward_no')){echo 'selected';}?>><?php echo  $w->name?></option>
