    ...
    <div class="container-fluid font-kalimati">
        ...
        <div class="bd-example bd-example-tabs">
            ...
            ?>
                ...
                <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#sifaris" role="tab" aria-controls="profile" aria-expanded="false"><i class="fa fa-eye"></i> PRINT PREVIEW</a>
                      ...
                      <table class="table table-bordered my-4">
                        ...
                        <tbody>
                         ...
                         <tr class="text-center font-bold font-20">
                              ...
                              <td colspan="2"><i class="fa fa-check-circle-o" style="color:<?php echo $details->status == 1 ? "red": $details->status == 2 ? "blue":$details->status == 3 ? 'green':'red';?>"></i> Address Verification Detail</td>
                                ...
                                <tr>
                                  ...
                                  <td colspan="2">
                                    ...
                                    <?php if($details->status == 1) { ?>
                                      <div class="col-lg-6">
                                        <a class="btn btn-warning btn-submit mt-3 btn-block  " href="<?= base_url() ?>address-verification-en/edit/<?= $details->id ?>/">सम्पादन गर्नुहोस्</a>
                                      </div>
                                      <div class="col-lg-6">
                                        <a class="btn btn-success btn-submit  mt-3 btn-block  " href="<?= base_url() ?>address-verification-en/darta/<?= $details->id ?>/">दर्ता गर्नुहोस</a>
                                      </div>
                                    ...
                                    <div class="col-lg-6">
                                      <a class="btn btn-success btn-submit mt-3 btn-block  " href="<?= base_url() ?>address-verification-en/chalani/<?= $details->id ?>/">चलानी गर्नुहोस</a>
                                    </div>
                                    <?php } ?>
                      ...
                      <div class="font-14 text-black" style="line-height: 1.6;">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="row non-border-input">
                                ...
                                <input type="text" id="office_sambodhan" class="form-control" value="<?= !empty($print_detail)? $this_office->sambodhan : ''?>">
                        ...
                        <div class="text-center mt-2 mb-5">
                            ...
                            <h4><span style="border-bottom: 1px solid black; margin-bottom: 3px;"> <span class="red"> SUB: </span> ADDRESS VERIFICATION </span>
                        ...
                        <div class="text-justify" style=" font-family: Arial; ">
                          ...
                          In reference to the subject <b><?php echo $gender?>. <?php echo $details->app_name?></b> 
                           ...
                           has submitted an application to this office requesting to make clear about this address it is hereby certified that this address was <?php echo $details->old_name?> VDC  <?php echo $details->old_ward?> and recently has been changed as <?= $per_gapa->english_name.", Ward No-".$details->per_ward.", ".$per_district->english_name?> according to the decision of the Government of Nepal applicable from 10th March 2017 A.D.(2073/11/27 B.S.) 
