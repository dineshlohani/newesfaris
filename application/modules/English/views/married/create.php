        ...
        <div class="col-md-6">
            ...
            <label class="col-sm-4 col-form-label"><span
              ...
              <div class="col-sm-8">
                <div class="input-group">
                  <input type="text" name="married_date_bs" value="<?=isset($result)?$result->nep_dob:''?>" maxlength="10" class="form-control nep_dob" required id="nepaliDate4" />
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" name="married_date_ad" readonly="true" value="<?=isset($result)?$result->eng_dob:''?>" class="form-control" required id="id_eng_dob" />
              </div>
            </div>
          </div>
        </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                        <input type="text" name="wife_father_name" placeholder=""  class="form-control" required="required" value="">
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                        <input type="text" name="wife_mother_name" placeholder=""  class="form-control" required="required" value="">
                      </div>
                    </div>
                  </div>
                </div>
