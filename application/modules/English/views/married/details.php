                      ...
                      <table class="table table-bordered my-4">
                        ...
                        <tbody>
                         ...
                         <tr class="text-center font-bold font-20">
                              ...
                              <td colspan="2"><i class="fa fa-check-circle-o" style="color:<?php echo $result->status == 1 ? "red": $result->status == 2 ? "blue":$result->status == 3 ? 'green':'red';?>"></i> Married Verification</td>
                                  ...
                                  <div class="row">
                                    ...
                                    <?php if($result->status == 1) { ?>
                                      ...
                                      <div class="col-lg-6">
                                        ...
                                        <a class="btn btn-warning btn-submit mt-3 btn-block  " href="<?= base_url() ?>married-en/edit/<?= $result->id ?>/">सम्पादन गर्नुहोस्</a>

                                      </div>

                                      <div class="col-lg-6">

                                        <a class="btn btn-success btn-submit  mt-3 btn-block  " href="<?= base_url() ?>married-en/darta/<?= $result->id ?>/">दर्ता गर्नुहोस</a>
                                    ...
                                    <div class="col-lg-6">
                                      ...
                                      <a class="btn btn-success btn-submit mt-3 btn-block  " href="<?= base_url() ?>married-en/chalani/<?= $result->id ?>/">चलानी गर्नुहोस</a>
                    ...
                    <div class="col-lg-12">
                      ...
                      <div class="font-14 text-black" style="line-height: 1.6;">
                        ...
                        <div class="text-justify" style=" font-family: Arial; ">
                          ...
                          This is to certified that  <b><?php echo 'Mr'?> <?php echo $result->app_name?></b> and Son of <b>Mr. <?php echo $result->father_name?></b> and <b> MRs. <?php echo $result->mother_name?></b> pan inhabitance of  <?php echo $per_gapa->english_name?> ward no.<?php echo $result->per_ward?>,<?php echo $per_district->english_name?>, <?php echo $per_state->english_name?>,Nepal and Mrs. <?php echo $result->wife_name?> daughter of Mr. <?php echo $result->wife_father_name?> and Mrs. <?php echo $result->wife_mother_name?> an inhabitance of <?php echo $wife_gapa->english_name?> ward no <?php echo $result->wife_ward?>, <?php echo $wife_district->english_name?>, <?php echo $wife_state->english_name?> got married on <?php echo $result->married_date_bs?>(BS)/ <?php echo $result->married_date_ad?>(AD) according to our office record. 
