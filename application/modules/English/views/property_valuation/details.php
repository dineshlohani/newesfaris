                      ...
                      <table class="table table-bordered my-4">
                        ...
                        <tbody>
                         ...
                         <tr class="text-center font-bold font-20">
                              ...
                              <td colspan="2"><i class="fa fa-check-circle-o" style="color:<?php echo $result->status == 1 ? "red": $result->status == 2 ? "blue":$result->status == 3 ? 'green':'red';?>"></i> Property Valuation Detail</td>
                                  ...
                                  <div class="row">
                                    ...
                                    <?php if($result->status == 1) { ?>
                                      ...
                                      <div class="col-lg-6">
                                        ...
                                        <a class="btn btn-warning btn-submit mt-3 btn-block  " href="<?= base_url() ?>property-valuation-en/edit/<?= $result->id ?>/">सम्पादन गर्नुहोस्</a>

                                      </div>

                                      <div class="col-lg-6">

                                        <a class="btn btn-success btn-submit  mt-3 btn-block  " href="<?= base_url() ?>property-valuation-en/darta/<?= $result->id ?>/">दर्ता गर्नुहोस</a>
                                    ...
                                    <div class="col-lg-6">
                                      ...
                                      <a class="btn btn-success btn-submit mt-3 btn-block  " href="<?= base_url() ?>property-valuation-en/chalani/<?= $result->id ?>/">चलानी गर्नुहोस</a>
                    ...
                    <div class="col-lg-12">
                      ...
                      <div class="font-14 text-black" style="line-height: 1.6;">
                        ...
                        <div class="text-center mt-2 mb-5">
                            ...
                            <h4><span style="border-bottom: 1px solid black; margin-bottom: 3px;"> <span class="red"> SUB: </span> CERTIFICATE OF ANNUAL INCOME </span>
                        ...
                        <div class="text-justify" style=" font-family: Arial; ">
                          ...
                          permanent resident of <?= $per_gapa->english_name.", Ward No ".$result->per_ward.", ".$per_district->english_name ?>., Nepal. <?php if($gender==1){echo 'son';} else {echo 'daughter';}?> Mr. <?php echo $result->father_name?> & Mrs. <?php echo $result->mother_name?> submitted an application with recommendation of the concerned ward requesting for recommendation of economic value of the Land in order to study abroad. Whereas,a deed of public inquiry conducted from the concerning ward is received in this regards; therefore, on the basis of the same; it is hereby recommended that the details of economic value of the applicant's is as follows:
