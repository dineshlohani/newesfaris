                                    ...
                                    <tr>
                                        <td colspan="2">
                                           <div class="row">
                                                ...
                                                ?>
                                                <div class="col-lg-6">
                                                    <a class="btn btn-warning btn-submit mt-3 btn-block  " href="<?= base_url() ?>nata-pramanit/edit/<?= $result->id ?>/">सम्पादन
                                                        गर्नुहोस्</a>
                                                </div>
                                                <div class="col-lg-6">
                                                    <a class="btn btn-success btn-submit  mt-3 btn-block  " href="<?= base_url() ?>nata-pramanit/darta/<?= $result->id ?>/">
                                                        दर्ता गर्नुहोस</a>
                                                </div>
                                                <?php
                                                    }
                                                ...
                                                <div class="col-lg-6">
                                                    <a class="btn btn-success btn-submit mt-3 btn-block  " href="<?= base_url() ?>nata-pramanit/chalani/<?= $result->id ?>/">
                                                        चलानी गर्नुहोस</a>
                                                </div>
                                                <?php
                                                    }
                ...
                <div class="tab-pane fade" id="sifaris" role="tabpanel" aria-labelledby="nav-profile-tab" aria-expanded="false">
                    ...
                    <div class="letter">
                        ...
                        <div class="text-center font-26" style="margin-bottom: 20px;">
                            <h4><span class="red" style="border-bottom: 1px solid black; margin-bottom: 5px;">नाता प्रमाणित प्रमाणपत्र</span>
                            </h4>
                        </div>
                        <div>
                        ...
                        <table class="table letter-table table-bordered mt-4">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?= $i ?></td>
                                    <td><?= $data->name ?> <?php if(!empty($data->death_date)){ ?> (<?php echo $data->death_date;?>)<?php } ?></td>
                                    <td><?= $relation->name ?></td>
